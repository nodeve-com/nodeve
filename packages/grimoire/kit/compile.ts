// YAML→concept resolver: compose the
...
// derived. Override semantics live in kit/overrides.ts. BUILD- AND TEST-ONLY (imports `yaml` +
// `fs`): codegen bakes the resolved trees and projected schemas into generated/ and consumers
...
import { type Obj, asList, enumerationMembers, fieldSource, isObj, layerIndex, propertyDoc, readYaml } from './concept-sources.ts';
