...
export { sensorId, type SensorIdParts } from './kit/sensor-id.ts';
...
export { overlayEnvVars } from './kit/env.ts';
...
export {
	...
	type SiteSensor,
	type ResolvedDevice,
} from './kit/site-view.ts';
export { type MeasurandCell, measurandCells, measurandSubTopic, isMeasurandFeature } from './kit/measurand-tree.ts';
...
export { validateSite } from './kit/validate-site.ts';
...
export { loadSiteBundle, resolveSite, siteConfigPath, SITE_BUNDLE_FILE } from './kit/site-load.ts';
export { bakeSite } from './kit/bake-site.ts';
...
//     (`bun run grimoire-generate`); `.crosswalk` projects a code to a borrowed vocabulary ---
export {
	ACCUMULATION,
	type Vocab,
	type VocabCode,
