...
export const schema: TSchema = Type.Object({ "title": Type.Optional(title_.schema), "description": Type.Optional(description_.schema), "body": Type.Optional(body_.schema), "identity": Type.Optional(identity_.schema), "refs": Type.Optional(refs_.schema), "schema": Type.Optional(schema_.schema), "column": Type.Optional(column_.schema), "measurand": Type.Optional(measurand_.schema) }, {"additionalProperties":false});

export type QuantityKind = { "title"?: title_.Title; "description"?: description_.Description; "body"?: body_.Body; "identity"?: identity_.Identity; "refs"?: refs_.Refs; "schema"?: schema_.Schema; "column"?: column_.Column; "measurand"?: measurand_.Measurand };
