...
export const schema: TSchema = Type.Array(Type.Object({ "title": Type.Optional(title_.schema), "description": Type.Optional(description_.schema), "body": Type.Optional(body_.schema), "identity": Type.Optional(identity_.schema), "refs": Type.Optional(refs_.schema), "schema": Type.Optional(schema_.schema), "networkLink": Type.Optional(networkLink_.schema), "ipAddresses": Type.Optional(ipAddresses_.schema) }, {"additionalProperties":false,"x-key-map":{"network_link":"networkLink","ip_addresses":"ipAddresses"}}));

export type NetworkInterfaces = Array<{ "title"?: title_.Title; "description"?: description_.Description; "body"?: body_.Body; "identity"?: identity_.Identity; "refs"?: refs_.Refs; "schema"?: schema_.Schema; "networkLink"?: networkLink_.NetworkLink; "ipAddresses"?: ipAddresses_.IpAddresses }>;
