...
export const schema: TSchema = Type.Array(Type.Object({ "title": Type.Optional(title_.schema), "description": Type.Optional(description_.schema), "body": Type.Optional(body_.schema), "identity": Type.Optional(identity_.schema), "refs": Type.Optional(refs_.schema), "schema": Type.Optional(schema_.schema), "ipBinding": Type.Optional(ipBinding_.schema) }, {"additionalProperties":false,"x-key-map":{"ip_binding":"ipBinding"}}));

export type IpAddresses = Array<{ "title"?: title_.Title; "description"?: description_.Description; "body"?: body_.Body; "identity"?: identity_.Identity; "refs"?: refs_.Refs; "schema"?: schema_.Schema; "ipBinding"?: ipBinding_.IpBinding }>;
