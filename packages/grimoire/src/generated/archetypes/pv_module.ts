...
export const schema: TSchema = Type.Object({ "title": Type.Optional(title_.schema), "description": Type.Optional(description_.schema), "body": Type.Optional(body_.schema), "identity": Type.Optional(identity_.schema), "refs": Type.Optional(refs_.schema), "schema": Type.Optional(schema_.schema), "product": Type.Optional(product_.schema), "dc": Type.Optional(dc_.schema), "tempCoefficients": Type.Optional(tempCoefficients_.schema), "physical": Type.Optional(physical_.schema) }, {"additionalProperties":false,"x-key-map":{"temp_coefficients":"tempCoefficients"}});

export type PvModule = { "title"?: title_.Title; "description"?: description_.Description; "body"?: body_.Body; "identity"?: identity_.Identity; "refs"?: refs_.Refs; "schema"?: schema_.Schema; "product"?: product_.Product; "dc"?: dc_.Dc; "tempCoefficients"?: tempCoefficients_.TempCoefficients; "physical"?: physical_.Physical };
