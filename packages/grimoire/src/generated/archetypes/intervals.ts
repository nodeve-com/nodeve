...
export const schema: TSchema = Type.Array(Type.Object({ "title": Type.Optional(title_.schema), "description": Type.Optional(description_.schema), "body": Type.Optional(body_.schema), "identity": Type.Optional(identity_.schema), "refs": Type.Optional(refs_.schema), "schema": Type.Optional(schema_.schema), "interval": Type.Optional(interval_.schema), "condition": Type.Optional(condition_.schema), "filter": Type.Optional(filter_.schema) }, {"additionalProperties":false}));

export type Intervals = Array<{ "title"?: title_.Title; "description"?: description_.Description; "body"?: body_.Body; "identity"?: identity_.Identity; "refs"?: refs_.Refs; "schema"?: schema_.Schema; "interval"?: interval_.Interval; "condition"?: condition_.Condition; "filter"?: filter_.Filter }>;
