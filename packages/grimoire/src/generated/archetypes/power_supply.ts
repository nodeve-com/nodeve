...
export const schema: TSchema = Type.Object({ "title": Type.Optional(title_.schema), "description": Type.Optional(description_.schema), "body": Type.Optional(body_.schema), "identity": Type.Optional(identity_.schema), "refs": Type.Optional(refs_.schema), "schema": Type.Optional(schema_.schema), "product": Type.Optional(product_.schema), "acPhase": Type.Optional(acPhase_.schema), "usbhid": Type.Optional(usbhid_.schema) }, {"additionalProperties":false,"x-key-map":{"ac_phase":"acPhase"}});

export type PowerSupply = { "title"?: title_.Title; "description"?: description_.Description; "body"?: body_.Body; "identity"?: identity_.Identity; "refs"?: refs_.Refs; "schema"?: schema_.Schema; "product"?: product_.Product; "acPhase"?: acPhase_.AcPhase; "usbhid"?: usbhid_.Usbhid };
