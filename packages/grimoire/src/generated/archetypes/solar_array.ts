...
export const schema: TSchema = Type.Object({ "location": Type.Optional(location_.schema), "pvStrings": Type.Array(Type.Object({ "ordinal": ordinal_.schema, "active": active_.schema, "seriesCount": seriesCount_.schema, "azimuth": azimuth_.schema, "tilt": tilt_.schema, "vocEff": Type.Optional(vocEff_.schema), "catalogItem": catalogItem_.schema }, {"additionalProperties":false,"x-key-map":{"series_count":"seriesCount","voc_eff":"vocEff","catalog_item":"catalogItem"}}), {"minItems":1}) }, {"additionalProperties":false,"x-key-map":{"pv_strings":"pvStrings"}});
