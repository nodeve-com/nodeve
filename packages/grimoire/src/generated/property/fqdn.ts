...
export type FqdnDataT = { readonly "description": { readonly "en": "Fully qualified domain name resolving to this address (host + domain, e.g. inverter.lan). No trailing dot. Optional — an address need not have a name." }; readonly "title": { readonly "en": "FQDN" } };
