...
export const SiUnitSchema: TSchema = Type.String();

export type SiUnit = string;

export type SiUnitDataT = { readonly "schema": { readonly "type": "string" }; readonly "title": { readonly "en": "SI symbol" } };

const _data: SiUnitDataT = {
	"schema": {
		"type": "string"
	},
	"title": {
