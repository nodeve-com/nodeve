...
export type MassDataT = { readonly "description": { readonly "en": "Physical mass of a part/module, kilograms." }; readonly "title": { readonly "en": "Mass (kg)"; readonly "pt": "Massa (kg)" } };
