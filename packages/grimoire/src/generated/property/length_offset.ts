...
export type LengthOffsetDataT = { readonly "description": { readonly "en": "Where the parameter's byte-length sits in the command (M4-ATX: 3) — the device echoes the width it should read/write." }; readonly "title": { readonly "en": "Length offset" } };
