...
export type IriTemplateDataT = { readonly "description": { readonly "en": "Template resolving a term id to its full IRI, with {id} as the placeholder." }; readonly "schema": { readonly "minLength": 1; readonly "type": "string" }; readonly "title": { readonly "en": "IRI template" } };
