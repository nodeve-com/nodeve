...
export type ConnectTimeoutMsDataT = { readonly "description": { readonly "en": "How long a connection attempt waits before giving up, integer milliseconds. Distinct from the per-transfer timeout_ms." }; readonly "title": { readonly "en": "Connect timeout (ms)"; readonly "pt": "Timeout de conexão (ms)" } };
