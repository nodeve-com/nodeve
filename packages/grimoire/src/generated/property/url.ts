...
export const UrlSchema: TSchema = Type.String({"minLength":1});

export type Url = string;

export type UrlDataT = { readonly "description": { readonly "en": "Homepage / documentation URL" }; readonly "schema": { readonly "minLength": 1; readonly "type": "string" }; readonly "title": { readonly "en": "URL" } };

const _data: UrlDataT = {
	"description": {
