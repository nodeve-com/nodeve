...
export type ConfigurationDataT = { readonly "description": { readonly "en": "USB configuration index (standard USB descriptor)." }; readonly "title": { readonly "en": "Configuration" } };
