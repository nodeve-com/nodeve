...
export const ConfigurationSchema: TSchema = Type.Integer({"minimum":0});

export type Configuration = number;

export type ConfigurationDataT = { readonly "description": { readonly "en": "USB configuration index (standard USB descriptor)." }; readonly "schema": { readonly "minimum": 0; readonly "type": "integer" }; readonly "title": { readonly "en": "Configuration" } };

const _data: ConfigurationDataT = {
	"description": {
