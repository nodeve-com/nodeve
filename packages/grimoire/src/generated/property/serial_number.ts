...
export const SerialNumberSchema: TSchema = Type.String({"minLength":1});

export type SerialNumber = string;

export type SerialNumberDataT = { readonly "schema": { readonly "minLength": 1; readonly "type": "string" }; readonly "title": { readonly "en": "Serial Number" } };

const _data: SerialNumberDataT = {
	"schema": {
		"minLength": 1,
		"type": "string"
	},
