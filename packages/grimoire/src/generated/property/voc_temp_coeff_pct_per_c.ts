...
export type VocTempCoeffPctPerCDataT = { readonly "description": { readonly "en": "Temperature coefficient of Voc, %/°C (negative). Drives the cold-morning Voc rise." }; readonly "title": { readonly "en": "Voc temperature coefficient (%/°C)" } };
