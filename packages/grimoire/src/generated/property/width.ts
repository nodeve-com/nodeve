...
export type WidthDataT = { readonly "description": { readonly "en": "Physical width of an enclosure/part, millimetres." }; readonly "title": { readonly "en": "Width (mm)"; readonly "pt": "Largura (mm)" } };
