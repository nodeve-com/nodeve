...
export const WidthSchema: TSchema = Type.Number({"exclusiveMinimum":0});

export type Width = number;

export type WidthDataT = { readonly "description": { readonly "en": "Physical width of an enclosure/part, millimetres." }; readonly "schema": { readonly "exclusiveMinimum": 0; readonly "type": "number" }; readonly "title": { readonly "en": "Width (mm)"; readonly "pt": "Largura (mm)" } };

const _data: WidthDataT = {
	"description": {
