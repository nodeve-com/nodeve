...
export const schema: TSchema = Type.Object({ "registryId": registryId_.schema, "term": term_.schema, "match": match_.schema }, {"additionalProperties":false,"x-key-map":{"registry_id":"registryId"}});
